...
import top.duanhong.steward.entity.po.*;
import top.duanhong.steward.entity.vo.FileTreeVo;
import top.duanhong.steward.mapper.StewFileMapper;
...
import top.duanhong.steward.utils.FileUtils;
...
public class FileService {
    ...
    public MethodExcuResult getAllFileListByType(FileSelectReq req) {
        ...
        List<StewFile> list=stewFileMapper.selectByExample(stewFileExample);
        if (list!=null){
            List<FileTreeVo> fileTree=FileUtils.getFileTree(list);
