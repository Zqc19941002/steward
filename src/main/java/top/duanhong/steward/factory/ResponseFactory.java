package top.duanhong.steward.factory;

import org.springframework.data.domain.Page;
import top.duanhong.steward.response.BaseResponse;
import top.duanhong.steward.response.PageResponse;
...
public class ResponseFactory {
    ...
    public static<T> PageResponse<T> getPageResponse(List<T> datas,Long totalCount,String message,int status){
        PageResponse<T> pageResponse = new PageResponse<>();
        pageResponse.setData(datas);
        pageResponse.setTotalCount(totalCount);
        pageResponse.setMessage(message);
